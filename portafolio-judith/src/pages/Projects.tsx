  ...
  const projects = [
    {
      ...
      title: "Intectrative Map ",
      description:
        "Tourism web app with an interactive map, geolocation, route calculation, and an administrative dashboard.",
...

    {
      ...
      title: "ChefPick ",
      description:
        "Recipe discovery platform focused on finding recipes based on available ingredients, with a responsive and reusable interface.",
    ...
    },
    {
      ...
      title: "GenCode Tech",
      description:
        "Responsive corporate website with reusable components, dynamic service pages, and a Sanity-powered blog.",
    ...
    },
    {
      ...
      description:
        "Responsive interactive wedding invitation with reusable sections and personalized event information.",
    ...
    },
    {
      ...
      description:
        "Motor rehabilitation video game developed in Unity and C#, featuring player calibration and motion-based interactions.",
    ...
    },
    {
      ...
      description:
        "Full-stack flight search application integrating the Amadeus API, with filters, data transformation, and tested backend services.",
    ...
    <>
      <section className="pt-36 md:pt-32 pb-28 flex items-center justify-center">
        <div className="relative  flex flex-col items-center ">
          ...
          <div
            className=" absolute z-30 -bottom-6 sm:bottom-[40px] md:bottom-[-14px] left-1/2
            -translate-x-1/2 flex flex-wrap justify-center items-center gap-12  sm:gap-8  md:gap-56 w-full"
          >
